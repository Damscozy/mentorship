...
export 'package:vector_graphics/vector_graphics.dart' show BytesLoader, vg, VectorGraphicUtilities, PictureInfo;
...
class SvgPicture extends StatelessWidget {
  ...
  const SvgPicture(
    ...
    @Deprecated('No code should use this parameter. It never was implemented properly. '
