...
class SvgTheme {
  ...
  bool operator ==(Object other) {
    ...
    return other is SvgTheme && currentColor == other.currentColor && fontSize == other.fontSize && xHeight == other.xHeight;
  }
  ...
  @override
  String toString() => 'SvgTheme(currentColor: $currentColor, fontSize: $fontSize, xHeight: $xHeight)';
}
...
class _DelegateVgColorMapper extends vg.ColorMapper {
  ...
  vg.Color substitute(String? id, String elementName, String attributeName, vg.Color color) {
    final Color substituteColor = colorMapper.substitute(id, elementName, attributeName, Color(color.value));
...
class SvgCacheKey {
  ...
  @override
  bool operator ==(Object other) {
    return other is SvgCacheKey && other.theme == theme && other.keyData == keyData && other.colorMapper == colorMapper;
  }
}
...
class SvgStringLoader extends SvgLoader<void> {
  ...
  @override
  bool operator ==(Object other) {
    return other is SvgStringLoader && other._svg == _svg && other.theme == theme && other.colorMapper == colorMapper;
  }
}
...
class SvgBytesLoader extends SvgLoader<void> {
  ...
  @override
  bool operator ==(Object other) {
    return other is SvgBytesLoader && other.bytes == bytes && other.theme == theme && other.colorMapper == colorMapper;
  }
}
...
class SvgFileLoader extends SvgLoader<void> {
  ...
  @override
  bool operator ==(Object other) {
    return other is SvgFileLoader && other.file == file && other.theme == theme && other.colorMapper == colorMapper;
  }
}
...
class _AssetByteLoaderCacheKey {
  ...
  @override
  bool operator ==(Object other) {
    return other is _AssetByteLoaderCacheKey && other.assetName == assetName && other.assetBundle == assetBundle && other.packageName == packageName;
  }

  @override
  String toString() => 'VectorGraphicAsset(${packageName != null ? '$packageName/' : ''}$assetName)';
}
...
class SvgAssetLoader extends SvgLoader<ByteData> {
  ...
  @override
  bool operator ==(Object other) {
    return other is SvgAssetLoader && other.assetName == assetName && other.packageName == packageName && other.assetBundle == assetBundle && other.theme == theme && other.colorMapper == colorMapper;
  }
...
class SvgNetworkLoader extends SvgLoader<Uint8List> {
  ...
  @override
  bool operator ==(Object other) {
    return other is SvgNetworkLoader && other.url == url && other.headers == headers && other.theme == theme && other.colorMapper == colorMapper;
  }
